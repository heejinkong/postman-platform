...
class workspaceService {
  ...
  delete = createAsyncThunk('workspaceService/delete', async (workspace: workspaceItem, thunkAPI) => {
  ...
  update = createAsyncThunk('workspaceService/update', async (workspace: workspaceItem, thunkAPI) => {
