      ...
      <Dialog open={open} onClose={handleClose}>
        <Box sx={{width:'100%'}} >
          ...
          <DialogActions sx={{padding:'16px 24px',width:'100%'}}>
            <Button sx={{padding:'8px 22px', fontSize:'15px !important'}} onClick={handleClose}>Cancel</Button>
            <Button sx={{padding:'8px 22px', fontSize:'15px !important'}} className='btnBlue' onClick={addWorkspace}>Create</Button>
          </DialogActions>
        </Box>
